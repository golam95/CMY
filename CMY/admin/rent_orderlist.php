...
<div class="titleright">
		 <h1 style="margin-bottom:38px;text-align:center;" class="page-title">***Rent Order list***</h1>
		</div>
...
<a style="background:#6F9BC0;padding:5px;color:white;text-decoration:none;border-radius:10px;font-weight:bold;margin-left:10px;border:4px solid #0570B5;" href="viewrent_deliveryservice.php"><span class="glyphicon glyphicon-home" ></span> View Delivery Service</a>
			...
			<div class="table-responsive">
                ...
                <div class="block">        
				   ...
				   <table id="datatable3" style="margin-left:40px;" class="table table-striped table-bordered table-hover" id="example">
					<thead>
						<tr>
						  <th style="text-align:center;background-color:#2769A1;color:white;">UserId</th>
							...
							<th style="text-align:center;background-color:#2769A1;color:white;">
                             quantity</th>
							 <th style="text-align:center;background-color:#2769A1;color:white;">
                             Date</th>
					...
					<tbody>
					 <?php 
								$query="select * from cus_orderent";
								$msg=$db->select($query);
								$i=0;
								if ($msg) {
						...
						<tr class="primary">
							...
							<div class="dropdown">
								  ...
								  <ul class="dropdown-menu">
								   ...
								   <?php 
									if ($result['status']=='0') {?>
									  <li><a href="deliveryservice_rent.php?updatedeli=<?php echo($result['orderId']); ?>">Delivery Service</a></li>
										 <li><h5 style="color:red;font-weight:bold;">Delivery Pending</h5></li>
										   <li><a style="color:green;font-weight:bold;" href="report/dailyrent_Invoice.php?invoiup=<?php echo($result['orderId']); ?>">Invoice</a></li>
