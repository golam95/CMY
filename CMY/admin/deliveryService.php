...
if ($_SERVER['REQUEST_METHOD']=='POST'&&isset($_POST['submit'])) {
	 ...
	 if (empty($Order_id)||empty($prodcutname)||empty($suppliername)) {
		    ...
		    $mailquery="select * from rent_deliveryservice where deliser_id ='$Order_id' limit 1";
             ...
             if ($mailcheck <> false) {
				...
				if ($mailcheck <> false) {
				    ...
				    $query = "INSERT INTO deliveryserevice(deliser_id,deliser_name,deliser_proname,deliser_date,userId)
					VALUES('$Order_id','$prodcutname','$suppliername','$date','$userid')"; 
...
<div class="content">
		...
		<a style="background:#6F9BC0;padding:5px;color:white;text-decoration:none;border-radius:10px;font-weight:bold;margin-left:20px;border:4px solid #0570B5;" href="viewdeliveryService.php"><span class="glyphicon glyphicon-home" ></span> View all delivery service</a>
		<a style="background:#6F9BC0;padding:5px;color:white;text-decoration:none;border-radius:10px;font-weight:bold;margin-left:40px;border:4px solid #0570B5;" href="orderlist.php"><span class="glyphicon glyphicon-home" ></span> OrderList</a>
