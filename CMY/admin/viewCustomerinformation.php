...
<div class="content">
	...
	<div class="titleright">
		 <h1 style="margin-bottom:38px;text-align:center;" class="page-title">***Customer Information***</h1>
		</div>
		...
		<a style="background:#6F9BC0;padding:5px;color:white;text-decoration:none;border-radius:10px;font-weight:bold;margin-left:10px;border:4px solid #0570B5;" href="addcustomerInformation.php"><span class="glyphicon glyphicon-plus-sign" ></span> Add Customer</a>
		<a style="background:#6F9BC0;padding:5px;color:white;text-decoration:none;border-radius:10px;font-weight:bold;margin-left:10px;border:4px solid #0570B5;" href="report/customerReport.php"><span class="glyphicon glyphicon-print" ></span> Print Customer</a>
