...
<div class="content">
		...
		<a style="background:#6F9BC0;padding:5px;color:white;text-decoration:none;border-radius:10px;font-weight:bold;margin-left:20px;border:4px solid #0570B5;" href="viewUserDetails.php"><span class="glyphicon glyphicon-home" ></span> View User</a>
             ...
             if ($mailcheck <> false) {
             	$error="<span class='error'>Email already exist !</span>";
				  ...
				  $query = "INSERT INTO customerinfo(cus_name,cus_email,cus_contactno,cus_deliverylocation,cus_address ,cus_sex,cus_date,cus_city,cus_country,role)   
				   VALUES('$name','$email','$contactno','$deliverylocation','$address','$gender','$date','$city','$country','3')";  
	 ...
	 <div class="col-md-6">
	    ...
	    <div class="form-group">
	     ...
	     <div class="form-group">
			  ...
			  <input class="form-control"  disabled type="text" name="inputrole" value="3"/>
			 </div>
