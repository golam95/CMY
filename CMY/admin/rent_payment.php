...
<div class="content">
		...
		<div class="titleright">
		 <h1 style="margin-bottom:18px;text-align:center;" class="page-title">***Rent Payment Details***</h1>
		</div>
 ...
 <div class="main-content">
           ...
           <div class="row">
            ...
            <div class="col-xs-11">
                ...
                if (isset($_GET['delid'])) {
                	$delid=$_GET['delid'];
                	$delquery="delete from rent_payment where id='$delid'";
		     ...
		     <thead>
			     <tr class="active">
				  ...
				  <?php 
					...
					<td style="color:black;text-align:center;font-weight:bold;font-size:12px;"><?php echo($result['productId']) ;?></td>
					 <td style="color:black;text-align:center;font-weight:bold;font-size:12px;"><?php echo($result['quantity']); ?></td>
					  <td style="color:black;text-align:center;font-weight:bold;font-size:12px;"><?php echo($result['total_amount']) ;?></td>
					   <td style="color:black;text-align:center;font-weight:bold;font-size:12px;"><?php echo($result['month']); ?></td>
					   <td style="color:black;text-align:center;font-weight:bold;font-size:12px;">
					   
					   
					   <?php if ($result['rent_status']=='0') {?>
					...
					<a onclick=" return confirm('Do you want to delete!!!');" style="padding:7px;background-color:red;border-radius:5px;text-decoration:none;color:white;height:40px;margin:5px;" href="?delid=<?php echo($result['id']); ?>"><span class="glyphicon glyphicon-trash"></span></a>
