...
?>
 ...
 <div class="content">
	   ...
	   <div class="titleright">
		 <h1 style="margin-bottom:38px;text-align:center;" class="page-title">***Product Information***</h1>
		</div>
		...
		<a style="background:#6F9BC0;padding:5px;color:white;text-decoration:none;border-radius:10px;font-weight:bold;margin-left:10px;border:4px solid #0570B5;" href="productadd.php"><span class="glyphicon glyphicon-plus-sign" ></span> Add Product</a>
			 ...
			 ?>
				<tr class="primary">
					...
					<a style="padding:7px;background-color:green;border-radius:5px;text-decoration:none;color:white;height:40px;margin:5px;" href="productedit.php?pdid=<?php echo($result['productId']) ;?>"><span class="glyphicon glyphicon-pencil"></span></a>
					 ...
					 <a onclick=" return confirm('Do you want to delete!!!');" style="padding:7px;background-color:red;border-radius:5px;text-decoration:none;color:white;height:40px;margin:5px;" href="?delpd=<?php echo($result['productId']) ;?>"><span class="glyphicon glyphicon-trash"></span></a>
					 <?php }?>
