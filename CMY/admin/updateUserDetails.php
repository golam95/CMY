...
<div class="content">
		...
		<div class="titleright">
		 <h1 style="margin-bottom:18px;text-align:center;" class="page-title">***Update User Information***</h1>
		</div>
		...
		<a style="background:#6F9BC0;padding:5px;color:white;text-decoration:none;border-radius:10px;font-weight:bold;margin-left:10px;border:4px solid #0570B5;" href="viewUserDetails.php"><span class="glyphicon glyphicon-home" ></span> View User</a>
