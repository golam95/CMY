	...
	table.table th{text-align:center;color:#FFFFFF;font-size:20px;font-weight:bold;}
td.t-data {
 ...
 if (!isset($_GET['id'])) {
  ...
  ?>
	...
	<!-- Shoping Cart -->
		...
		<div class="container">
		<div class="row">
			    	<h2 style="margin-left:500px;color:#1782DC;font-weight:bold;">Your Cart</h2>
			    	<?php 
			    	 ...
			    	 ?>
						...
						<table class="table">
						   <tr>
						     ...
						     <th></th>
						     <th></th>
							 <th><a style="padding:5px;text-decoration:none;font-weight:bold;font-size:18px;background-color:#1782DC;color:white;border-radius:5px;" href="payment.php"><i class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></i> Check Out</a></th>
						   </tr>
							<tr>
							...
							<tr class="cross">
								...
								<td style="width:30%;" class="ring-in t-data"><?php echo($result['productName']) ;?></td>
								...
								<form action="" method="POST">
										...
										<input style="border:1px solid #D2D2D2;margin-left:100px;" type="number" name="quantity" value="<?php echo($result['quantity']); ?>"/>
										<input style="padding:5px;background:#1782DC;margin-top:2px;color:#FFFFFF;border-radius:4px;margin-left:100px;" type="submit" name="submit" value="Update"/>
									</form>
					...
					<div class="shopping">
						<div class="shopleft">
							<a href="product.php"> <img src="images/shop.png" alt="" /></a>
						</div>
